                ...
                <table className="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="align-middle border-0"><a className="reset-anchor" href="#"><i className="fas fa-trash-alt small text-muted"></i></a></td>
                    </tr>
                    <tr>
