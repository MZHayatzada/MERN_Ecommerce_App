const products = [{
        ...
        reviews: [{
            reviewer: 'Zafar',
            review: 'Very good product. Battery lasts more than 4 hours. Amazing product',
            rating: 4
        }]
    },
    {
    ...
    },
    {
        ...
        quantity: 10,
        category: 'Lifestyle',
        longDescription: 'An iconic basic white tee shirt with clean lines and a classic crew neck. Midweight fabric & soft handfeel that gets softer over time. Finished with branded emblem on the bottom',
        reviews: [{
            reviewer: 'Zarif',
            review: 'Stylish one. I like its quality and amazing fast delivery',
            rating: 4
        }, {
            reviewer: 'Haseeb',
            review: 'Normal Delivery. Looks very nice. Very happy.',
            rating: 5
        }, {
            reviewer: 'Shahid',
            review: 'Working fine. Looks amazing and fast delivery',
            rating: 4
        }]
    },
    {
        ...
        quantity: 10,
        category: 'Lifestyle',
        longDescription: 'Smart watch pair with all ios smart phone and all android smart phone,not pair with windows phone.Smart Watch Support SIM & Bluetooth Phone Call GPS Smartwatch Phone Men Women IP67 Waterproof Heart Rate Monitor Clock',
        reviews: [{
            reviewer: 'Sana',
            review: 'So beautiful and Stylish one. I like its quality and amazing fast delivery',
            rating: 4
        }, {
            reviewer: 'Haseeb',
            review: 'Normal Delivery. Looks very nice. Very happy.',
            ...
            reviewer: 'Zakria',
            review: 'I like its quality and amazing fast delivery. Stylish one. I like its quality and amazing fast delivery',
            rating: 4
        }]
    }
];
